...
def generate_functions(modules = all_modules.module_name, EntityID = 1):
    ...
    for module_name in modules:
        ...
        function_text_lines = '# This module contains ' + module_name + ' functions.'
        
        function_text_lines += "\n\n"
        
        function_text_lines += 'from .Utilities import *'
        
        function_text_lines += "\n\n"
        
        function_text_lines += 'import pandas as pd'
        
        function_text_lines += '\n\n'
        
        function_text_lines += 'import json'
        
        function_text_lines += '\n\n'
        
        function_text_lines += 'import re'
